...
Welcome to the documentation for the Celestial Mechanics Calculations API. This project is a modern **FastAPI** backend designed to provide accurate celestial mechanics calculations for frontend applications.
